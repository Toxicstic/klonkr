  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `questions_table` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `questions` TEXT NOT NULL, `mode` TEXT NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'c64158d1b893e63a99097be20dc5cadd')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsQuestionsTable.put("questions", new TableInfo.Column("questions", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsQuestionsTable.put("mode", new TableInfo.Column("mode", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoQuestionsTable.equals(_existingQuestionsTable)) {
          return new RoomOpenHelper.ValidationResult(false, "questions_table(nl.linsoft.klonkr.data.User).\n"
                  + " Expected:\n" + _infoQuestionsTable + "\n"
                  + " Found:\n" + _existingQuestionsTable);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "c64158d1b893e63a99097be20dc5cadd", "16770f4f51f49ee24c793b76275f2f2f");
